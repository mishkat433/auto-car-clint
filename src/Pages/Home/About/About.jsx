        ...
        <div className="my-20" >
            <div className="flex flex-col justify-between items-center gap-10 lg:flex-row">
                <div className='w-full lg:w-1/2 relative' data-aos="fade-right">
                    <img className='w-full lg:w-4/5 h-[350px] lg:h-[450px]' src={person} alt="about" />
                    <img className='absolute lg:-bottom-6 bottom-0 right-0 lg:right-28 w-2/5 h-[150px] lg:h-[300px] border-orange-500 border-8 lg:rounded-xl' src={parts} alt="about" />
                </div>
