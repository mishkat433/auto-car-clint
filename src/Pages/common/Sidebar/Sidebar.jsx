            ...
            <div className="drawer-side">
                <label htmlFor="my-drawer-2" className="drawer-overlay"></label>
                {
                    findAdmin ? <ul className="menu p-4 overflow-y-auto bg-base-100 text-base-content ">
                        ...
                        <li><NavLink className={({ isActive }) => isActive ? "text-black font-bold bg-gray-200 mb-2" : "mb-2"} to="/admin/addProduct"><FcPlus className='text-2xl' /> Add Services</NavLink></li>
                        <li><NavLink className={({ isActive }) => isActive ? "text-black font-bold bg-gray-200 mb-2" : "mb-2"} to="/admin/allProduct"><FcFilingCabinet className='text-2xl' /> All Services</NavLink></li>
